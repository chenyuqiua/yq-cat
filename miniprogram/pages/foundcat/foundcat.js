...
// import { getAvatar, getVisitedDate } from "../../cat";
...
//   onLoad: async function (options) {
//     const db = cloud.database();
//     // const foundcat = db.collection("found_cat");
//     const foundcat = db.collection("cat");
//     const cats = await foundcat.where({
//       adopt: 2
//     }).get();
//     this.setData({ cats: cats.data })
//   },
//   /**
//    * 页面上拉触底事件的处理函数
//    */
...
//     const _ = db.command;
//     // const query = this.fGet();
//     var new_cats = (await cat.orderBy('mphoto', 'desc').orderBy('popularity', 'desc').skip(cats.length).limit(step).get()).data
//     new_cats = shuffle(new_cats);
...
//     const cat = db.collection('found_cat');
//     // const query = this.fGet();
//     const cat_count = (await cat.count()).total;
